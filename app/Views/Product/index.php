                    ...
                    <div class="col car_custom">
                        ...
                        <div class="card-healll">
                            ...
                            <div class="d-flex justify-content-around fs-sm">
                                <span><i class="fas fa-list-check color-blue fs-5">
                                        7385 approved listings
                                    </i></span>
                                <span><i class="fas fa-list-check color-blue">
                                        889 legit sellers
                                    </i></span>
                            </div>
                        </div>
                    ...
                    <ul class="nav justify-content-center mt-5">
                        ...
                        <li class="nav-item">
                            <a class="nav-link-113 link-info">
                                <i class="fas fa-arrow-right">Shop Phone</i>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="more-us row">
                    <div class="big-more-us col-6 col-sm-4">
                        ...
                        <div class="about-us-more">
                            <p>On Swappa, you buy and sell directly with other users. No middleman means you get the
                                best
                    ...
                    <div class="big-more-us col-6 col-sm-4">
                        ...
                        <div class="about-us-more">
                            <p>Our moderation staff uses the latest, greatest AI and machine-learning tools to fight
                                fraud
                    ...
                    <div class="big-more-us col-6 col-sm-4">
                        ...
                        <div class="about-us-more">
                            <p>Swappa has fair fees, just 3% per party. That means buyers save more and sellers keep
                                more
                    ...
                    <div class="big-more-us col-6 col-sm-4">
                        ...
                        <div class="about-us-more">
                            <p>Our support is provided by real humans who actually care. Swappa's typical response time
                                for
